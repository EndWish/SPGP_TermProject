...
public class ArrowBlasterAttack3 extends Attack {
    float lifeTime = 0.5f;

    public ArrowBlasterAttack3(BattleProfile caster, BattleProfile target) {
        super(caster, target, caster.getX(), caster.getY());
        
        // 스프라이트를 생성
        sprite = new Sprite(new Sprite.Builder(R.mipmap.png_effect_skill_arrow_blaster3, 0,0, 400, 440)
