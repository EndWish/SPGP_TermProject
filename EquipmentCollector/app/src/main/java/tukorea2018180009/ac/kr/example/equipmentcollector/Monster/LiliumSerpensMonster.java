...
public class LiliumSerpensMonster extends Adventurer {
    private static final String name = "LiliumSerpens";
    private static final Bitmap icon = BitmapPool.get(R.mipmap.png_icon_adventurer_arthur_256x256);
    private static final Bitmap profile = BitmapPool.get(R.mipmap.png_profile_monster_lilium_serpens_256x384);
    ...
    protected void initBasicStatus() {
        ...
        basicStatus.set(Status.Type.cursedResistance, 9);
